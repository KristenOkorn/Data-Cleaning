# -*- coding: utf-8 -*-
"""
Created on Mon Nov 28 09:09:24 2022

@author: okorn

#get temperature & pressure to line up instrument start time
"""
...
for i in range(len(fileList)-1):
    ...
    #load in the file
    temp = pd.read_csv(filePath,skiprows=35,usecols=['Timestamp','Pressure','Temperature'])
...
savePath = os.path.join(path,'caps_temp_hum.csv')
