...
#locations = ['SLC-Hawthorne']
#locations = ['AldineTX','AustinTX','HoustonTX','LibertyTX']
locations = ['Bayonne','Bronx','Cornwall','EastProvidence','Hawthorne','Londonderry','NewHaven','Philadelphia','Pittsburgh','Queens','SWDetroit','WashingtonDC']

pollutant = 'SO2'

#load in the Pandora data
#create a directory path for us to pull from / save to
path = 'C:\\Users\\kokorn\\Documents\\Modeling Surface Concentrations\\New Pandora July 2024'
#path = 'C:\\Users\\okorn\\Documents\\2023 Deployment\\Pandora 2023'
#path = 'C:\\Users\\okorn\\Documents\\FRAPPE (2024 Modeling)\\NOAA Boulder'
#path = 'C:\\Users\\okorn\\Documents\\FRAPPE (2024 Modeling)\\SLC Hawthorne'
    ...
    for n in range(len(pollutant)):
            ...
            if locations[k] == 'SJSU':
                ...
                if pollutant == 'O3':
                    ...
                    layers = []
                    #get names for the layer columns - for O3 only
                    for x in range(69, len(data.columns)):
                        layers.append(f'layer_col{x}')
                
                elif pollutant == 'SO2':
                    desired_cols = [0,3,11,32,38,44,49,25]
                    #datetime, SZA, pressure, quality flag, total column SO2, TEff, O3 AMF, Atmos. Variability
            ...
            #Only keep the datetime & necessary columns
            ...
            if locations[k] == 'SJSU':
                ...
                data.columns = ['datetime','SZA','pressure','quality_flag','{}'.format(pollutant),'TEff','AMF','Atmos Variability']
                                #datetime, SZA, pressure, quality flag, total column O3, TEff, O3 AMF, Atmos. Variability
