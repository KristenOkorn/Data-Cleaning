...
locations = ['AldineTX','Hampton','Hawthorne','SWDetroit']
pollutants = 'NO2'
    ...
    for n in range(len(pollutants)):
            ...
            if locations[k] == 'SJSU':
                ...
                if pollutants == 'NO2':
                    ...
                    desired_cols = [0, 55, 38, 56, 14, 63, 64, 67, 13, 3] + list(range(layer, len(data.columns)))
                    ...
                    desired_cols = [0, 44, 38, 45, 14, 50, 51, 52, 13, 3] + list(range(layer, len(data.columns)))
            ...
            if locations[k] == 'SJSU':
                data.columns = ['datetime','{}'.format(pollutants),'quality_flag','uncertainty','temperature','pressure','SZA']
            else:
                data.columns = ['datetime','{}'.format(pollutants),'quality_flag','surface_uncertainty','temperature','max_horiz','max_vert_tropo','top_height','pressure','SZA'] + layers
